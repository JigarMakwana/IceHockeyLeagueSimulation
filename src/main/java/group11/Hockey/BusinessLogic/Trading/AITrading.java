...
public class AITrading implements IAITrading extends StateMachineState {
    ...
    IRandomNoGenerator randomFloat = new RandomNoGenerator();
    ...
    public void generateTradeOffers() {
        ...
        for (int i=0; teamLength > 1; i=0) {
            ...
            if(isAITeam) {
                float randomTradeOfferChance = randomFloat.generateRandomFloat();
    ...
    public void resolveAIToAITrade(Team team1, List<Player> offeredPlayerList,
        ...
        float randomAcceptanceChance = randomFloat.generateRandomFloat();;
    ...
    public void acceptTrade(Team team1, List<Player> offeredPlayerList,
                            Team team2, List<Player> requestedPlayerList) {
