...
public class TradingModelMock {
	...
	private void init(float randomTradeOfferChance, float randomAcceptanceChance) {
		...
		this.tradingConfig = new TradingConfig(2, this.randomTradeOfferChance, 2, this.randomAcceptanceChance, gmTbale);
	...
	private void addLeague() {
		...
		GameplayConfig gameplayConfig = new GameplayConfig(aging, injuries, training, this.trading);
